...
var GiftedListView = React.createClass({
  ...
  paginationFetchingView() {
    ...
    return (
      <View style={[this.defaultStyles.paginationView, this.props.customStyles.paginationView]}>
        <Text>paginationFetchingView</Text>
      </View>
    );
  ...
  refreshableWillRefreshView() {
    if (this.props.refreshableWillRefreshView) {
      return this.props.refreshableWillRefreshView(this.state.prevRefreshStatus);
    }
  ...
  refreshableWaitingView(refreshCallback) {
    if (this.props.refreshableWaitingView) {
      return this.props.refreshableWaitingView(refreshCallback, this.state.prevRefreshStatus);
    }
  ...
  getInitialState() {
    ...
    if (this.props.refreshable === true && Platform.OS !== 'android') {
      console.log('getInitialState: ', this.props.refreshableViewHeight);
  ...
  _postRefresh(rows = [], options = {}) {
    if (this.isMounted()) {
      ...
      if (this.props.refreshable === true && Platform.OS !== 'android') {
        ...
        // console.log('_postRefresh: ', this.props.refreshableViewHeight);
  ...
  _onScroll(e) {
    ...
    if (this.props.refreshable === true) {
      if (Platform.OS !== 'android') {  
        // |scrollResponderHandleScrollShouldSetResponder()| Ref 'ScrollResponder.js'  
        ...
        && this._scrollResponder.scrollResponderHandleScrollShouldSetResponder() === true
          ...
          this.setState({
            ...
            prevRefreshStatus: 'waiting',
            isRefreshing: false,
          });
        } else if (this._getY() > this.props.refreshableViewHeight - this.props.refreshableDistance
        && this.state.refreshStatus === 'willRefresh'
        && this._scrollResponder.scrollResponderHandleScrollShouldSetResponder() === true) {
          this.setState({
            refreshStatus: 'waiting',
            prevRefreshStatus: 'willRefresh',
            isRefreshing: false,
          });
        }
      }
